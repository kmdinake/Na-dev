...
begin
  ...
  fDateReceived   :=StrToDate('2012/12/31');
  fDateCollected  :=StrToDate('2012/12/31');
  fCollected      := False;
  fCategory    := 'Food';
end;
...
begin
  getDateCollected := DateToStr(fDateCollected);
end;

function TParcel.getDateReceived: String;
begin
  getDateReceived := DateToStr(fDateReceived);
end;
...
begin
  fDateCollected := strtoDate(theDateC);
end;

procedure TParcel.setDateReceived(theDateR: String);
begin
  fDateReceived := StrToDate(theDateR);
end;
